 ...
 *
 * This module centralizes all static assets and configuration data used in the application.
 *
 * Contains:
 * - Image assets (logos, icons, samples)
 * - Step-by-step guide data
 * - Testimonial content
 * - Pricing plan information
 *
 * Asset Categories:
 * 1. Brand Assets (logo, icons)
 * 2. UI Elements (stars, ratings)
 * 3. Sample Images
 * 4. Social Media Icons
 * 5. User Interface Icons
 *
 * Usage:
 * Import the assets object or specific data arrays as needed
 */
